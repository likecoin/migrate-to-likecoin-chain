  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'og_description', property: 'og:description', content: 'LikeCoin-ERC20 - LikeCoin chain Migration' },
      { hid: 'og_image', property: 'og:image', content: 'https://migration.like.co/images/og/default.png' },
